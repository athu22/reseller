...
import { getDatabase, ref, set, get, update, onValue, push, query, orderByChild, equalTo, remove } from 'firebase/database';
...
export { auth, database, ref, set, get, update, onValue, push, query, orderByChild, equalTo, remove };
