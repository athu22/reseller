...
const CourseLandingPage = () => {
  ...
  const handleShareLink = () => {
    if (!userId) {
      alert("Please login to share the course link");
      return;
    }
    
    const viewUrl = `${window.location.origin}/view-course/${userId}/${courseId}`;
    navigator.clipboard
      .writeText(viewUrl)
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-white text-blue-600 px-4 py-1.5 rounded-lg hover:bg-blue-50 transition-colors duration-300 shadow-md hover:shadow-lg text-sm"
            >
              Share Link
            </button>
          </div>
